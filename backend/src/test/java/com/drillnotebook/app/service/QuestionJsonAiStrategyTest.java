...
class QuestionJsonAiStrategyTest {
    ...
    void callsAiAndParsesJson() {
        ...
        QuestionJsonAiStrategy strategy = new QuestionJsonAiStrategy(aiService, jsonParser);
        ImportRequest req = new ImportRequest(1L, "broken json", null, "pw", false);
